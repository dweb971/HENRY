...
<ul>
    <li>
        <a href="" class="btn btn-primary" id="liste">Liste utilisateur</a>
    </li>
    <li>
...
<div class="addU" id="aU">
    ...
    <form method="POST" action="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/backend/validation.php">
        <div class="form-group">
            <label for="">NOM : *</label>
            <input type="text" class="form-control" id="" aria-describedby="" name="nom" placeholder="NOM"
                minlength="1" maxlength="1000" required>
        </div>
        <div class="form-group">
            <label for="">Prenom : *</label>
            <input type="text" class="form-control" id="" aria-describedby="" name="prenom" placeholder="Prenom"
                minlength="2" maxlength="1984" required>
        </div>
        <div class="form-group">
            <label for="">Téléphone : *</label>
            <input type="tel" class="form-control" id="" aria-describedby="" name="telephone" placeholder="Téléphone"
                minlength="10" maxlength="15" required>
        </div>
        <div class="form-group">
            <label for="">Date de naissance : *</label>
            <input type="date" class="form-control" id="" aria-describedby="" name="naissance"
                placeholder="Date de naissance" minlength="12" maxlength="12" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Email address</label>
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email"
                placeholder="email" minlength="7" maxlength="5977" required>
            <small id="emailHelp" class="form-text text-muted"></small>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input type="password" class="form-control" id="exampleInputPassword1" name="password"
                placeholder="password" minlength="6" maxlength="10" required>
        </div>
